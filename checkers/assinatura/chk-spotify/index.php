      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
           <div align='left' class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Checker Spotify</h3>
    ...
    <div class="col-md-9">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="basic-layout-form" align='left'>STATUS: <span id="status_ccs" >Checker Spotify</span></h4>
...
<!--            <div class="card-text" align='left'>
    ...
    <div class="col-md-3">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" align='left'>STATUS</h4>
          <a class="heading-elements-toggle">
            <i class="la la-ellipsis-v font-medium-3"></i>
          </a>
          <div class="heading-elements">
...
<br>
    ...
    <div class="col-md-15">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" align='left' >Reprovadas/Aprovadas -&nbsp;<span id="dies_cs" class="badge badge-danger">0</span></h4>
          <a class="heading-elements-toggle">
            <i class="la la-ellipsis-v font-medium-3"></i>
          </a>
          <div class="heading-elements">
