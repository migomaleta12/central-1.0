...
exit('<b><span class="badge badge-success">ENCONTRADO</span> ➜ <font style=color:#FFFFFF>CEP : '.$cep.' | ESTADO : '.$estado.' | CIDADE : '.$cidade.' |  ENDEREÇO : '.$ende.' | BAIRRO : '.$bairro.' | DDD : '.$ddd.'  </font></b><br>');}

else{
exit('<b><span class="badge badge-danger">CEP INVÁLIDO</span> ➜ '.$email.' ➜ ' . (time() - $time) .  ' Seg</b><br>');}
