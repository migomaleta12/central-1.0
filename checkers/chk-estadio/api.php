...
if (strpos($data1, '"token"')) {
	...
	exit('<b><span class="badge badge-success">Aprovada</span> ➜ ' . $email . '|' . $senha . ' ➜ <font style=color:#ffcc00>' . $dados . '</font> ➜ <span class="badge badge-primary">Logado Com Sucesso</span> ➜ ' . ('CENTRAL 1.0') .  '</b><br>');
} else {
	exit('<b><span class="badge badge-danger">Reprovada</span> ➜ ' . $email . '|' . $senha . ' ➜ <span class="badge badge-primary">Dados Incorretos</span>  </b><br>');
}