...
if(strpos($fim, 'OK') !== false) {
	echo '<span class="badge badge-success">#Aprovada by @alex </span> '.$cc.' '.$mes.' '.$ano.' '.$cvv.' <b>'.$bin.'</b>';
} else {
	echo '<span class="badge badge-danger">#Reprovada by @alex </span> '.$cc.' '.$mes.' '.$ano.' '.$cvv.' <b>'.$bin.'</b>';
}
