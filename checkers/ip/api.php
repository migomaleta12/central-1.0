...
exit('<b><span class="badge badge-success">ENCONTRADO</span> ➜ '.$ip. ' ➜ <font style=color:#FFFFFF>'.$dados.'</font> </b><br>');}

else {
exit('<b><span class="badge badge-danger">IP INVÁLIDO</span> ➜ '.$ip.' ➜ ' . (time() - $time) .  ' Seg</b><br>');}
}
?>