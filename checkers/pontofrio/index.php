      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
           <div align='left' class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Checker ponto frio</h3>
...
<!--            <div class="card-text" align='left'>
            ...
            <form class="form">
              <div class="form-body">
                <textarea style="font-size: 100%; height: 208px; text-align:center; width:100%;resize:none;outline:none;overflow: hidden;" class="form-control" align='left' rows="4" id="lista_ccs" placeholder="email e senha"></textarea>
