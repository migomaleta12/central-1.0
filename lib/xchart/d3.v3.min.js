d3 = (function () {
  ...
  function A(n) {
    return (
      arguments.length || (n = $o.ascending),
      function (t, e) {
  ...
  function nt(n, t, e) {
    return n > 0
      ? B(Math.atan2(e, t) * Ta, Math.sqrt(t * t + e * e), n)
      : B(0 / 0, 0 / 0, n);
  }
  function tt(n) {
  ...
  function ft(n, t, e) {
    ...
    var r = et((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / Oa),
      u = et((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / Ya),
      i = et((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / Ia);
  ...
  function xt() {
    var n = Mt(),
      t = _t() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(Ja), (Ja = setTimeout(xt, t))), (Wa = 0))
      : ((Wa = 1), Ka(xt));
  }
  function Mt() {
    var n = Date.now();
  ...
  function ue(n, t, e, r) {
    ...
    return function (a) {
      ...
      function p() {
        d && (v(x, M), _ && S && C.rejoin(), d.push(C.buffer())),
          (L.point = h),
          S && a.lineEnd();
      }
      function v(n, t) {
        ...
        if ((m && y.push([n, t]), k))
          ...
          N(r)
            ? (S || (a.lineStart(), a.point(r.a.x, r.a.y)),
              a.point(r.b.x, r.b.y),
              e || a.lineEnd(),
              (E = !1))
            : e && (a.lineStart(), a.point(n, t), (E = !1));
        }
        (b = n), (w = t), (S = e);
      }
      var d,
    ...
    var u = Math.cos(t),
      ...
      p = h
        ? function (n) {
            ...
            return [
              Math.atan2(u, r) * Ta,
              Math.atan2(o, Math.sqrt(r * r + u * u)) * Ta,
            ];
          }
        : function () {
            return [n * Ta, t * Ta];
  ...
  function He(n, t) {
    ...
    return i
      ? ((e.invert = function (n, t) {
          ...
          return [
            Math.atan2(n, e) / i,
            2 * Math.atan(Math.pow(o / r, 1 / i)) - Aa,
          ];
        }),
        e)
      : Oe;
  ...
  function Qe(n) {
    ...
    for (
      var c = i;
      c.circle && aa(e - c.circle.x) < Ca && aa(r - c.circle.cy) < Ca;

    )
      (i = c.P), a.unshift(c), Ke(c), (c = i);
    a.unshift(c), cr(c);
    for (
      var s = o;
      s.circle && aa(e - s.circle.x) < Ca && aa(r - s.circle.cy) < Ca;

    )
      (o = s.N), a.push(s), Ke(s), (s = o);
    a.push(s), cr(s);
    var l,
      f = a.length;
    for (l = 1; f > l; ++l)
      (s = a[l]), (c = a[l - 1]), pr(s.edge, c.site, s.site, u);
    (c = a[0]),
      (s = a[f - 1]),
  ...
  function cr(n) {
    var t = n.circle;
    t &&
      (t.P || (Bc = t.N), Wc.remove(t), Gc.push(t), mr(t), (n.circle = null));
  }
  function sr(n) {
    for (
      var t, e = Vc, r = re(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length;
      u--;
      ...
      (t = e[u]),
        (!lr(t, n) ||
          !r(t) ||
          (aa(t.a.x - t.b.x) < Ca && aa(t.a.y - t.b.y) < Ca)) &&
  ...
  function _r(n, t) {
    ...
    for (Vc = [], Xc = new Array(n.length), $c = new dr(), Wc = new dr(); ; )
      if (((u = Bc), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        (i.x !== e || i.y !== r) &&
          ((Xc[i.i] = new rr(i)), nr(i), (e = i.x), (r = i.y)),
          (i = n.pop());
      else {
        if (!u) break;
        Qe(u.arc);
  ...
  function qr(n, t) {
    for (
      var e, r = $o.interpolators.length;
      --r >= 0 && !(e = $o.interpolators[r](n, t));
  ...
  function Gr(n) {
    ...
    t[0] * e[1] < e[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (u *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Ta),
    ...
    return (
      a[0] != c[0] || a[1] != c[1]
        ? (r.push("translate(", null, ",", null, ")"),
          u.push({ i: 1, x: Lr(a[0], c[0]) }, { i: 3, x: Lr(a[1], c[1]) }))
        : c[0] || c[1]
        ? r.push("translate(" + c + ")")
        : r.push(""),
      s != l
      ...
      f != h
        ? u.push({ i: r.push(r.pop() + "skewX(", null, ")") - 2, x: Lr(f, h) })
  ...
  function ou(n, t) {
    if (n === t) return n;
    for (
      var e = iu(n), r = iu(t), u = e.pop(), i = r.pop(), o = null;
      u === i;
  ...
  function hu(n, t) {
    return (
      $o.rebind(n, t, "sort", "children", "value"),
      (n.nodes = n),
      (n.links = du),
      n
    );
      ...
      if (
        ...
        for (
          ...
          if (1 == p)
            for (
              c = r._pack_prev;
              c !== a._pack_prev && !Yu(c, i);
              c = c._pack_prev, d++
            );
          p
            ? (d > v || (v == d && u.r < r.r) ? Ou(r, (u = a)) : Ou((r = c), u),
              o--)
            : (Fu(r, i), (u = i), t(i));
        }
      var m = (l + f) / 2,
  ...
  function fi(n, t, e) {
    ...
    return $o.format(
      e
        ? e.replace(uc, function (n, t, e, u, i, o, a, c, s, l) {
  ...
  function gi(n, t) {
    var e = hi(t[2]);
    return n in ls
      ? Math.abs(e - hi(Math.max(Math.abs(t[0]), Math.abs(t[1])))) +
          +("e" !== n)
      : e - 2 * ("%" === n);
  }
  function pi(n, t, e, r) {
    ...
    return (
      ...
      (o.tickFormat = function (n, t) {
        ...
        arguments.length < 2
          ? (t = fs)
          : "function" != typeof t && (t = $o.format(t));
        var r,
  ...
  function vi(n, t, e) {
    ...
    return (
      ...
      (r.exponent = function (o) {
        return arguments.length
          ? ((u = di((t = o))), (i = di(1 / t)), n.domain(e.map(u)), r)
          : t;
      }),
      (r.copy = function () {
  ...
  function Ei(n) {
    function t(t) {
      ...
      for (
        var c, s = [], l = [], f = -1, h = t.length, g = pt(e), p = pt(r);
        ++f < h;
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (i = n) : (i = xs.get(n) || Ai).key),
            t)
          : o;
      }),
  ...
  function zi(n, t) {
    return n.length < 3
      ? Ai(n)
      : n[0] +
          Di((n.push(n[0]), n), Pi([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function Ri(n, t) {
  ...
  function Ui(n) {
    ...
    for (n.push(n[e - 1]); ++t <= e; )
      (r = n[t]), o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), Yi(c, o, a);
  ...
  function ji(n) {
    ...
    for (e.push(Oi(bs, i) + "," + Oi(bs, o)), --r; ++r < u; )
      (t = n[r]), i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), Yi(e, i, o);
    return e.join("");
  }
  function Hi(n) {
    for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4; )
      (e = n[r % u]), o.push(e[0]), a.push(e[1]);
    for (t = [Oi(bs, o), ",", Oi(bs, a)], --r; ++r < i; )
      (e = n[r % u]),
        o.shift(),
        o.push(e[0]),
        a.shift(),
  ...
  function Bi(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (a = n) : (a = xs.get(n) || Ai).key),
            (s = a.reverse || a),
            (l = a.closed ? "M" : "L"),
            t)
          : c;
  ...
  ($o.ascending = function (n, t) {
    ...
    ($o.median = function (t, e) {
      return (
        ...
        (t = t.filter(n)),
        t.length ? $o.quantile(t.sort($o.ascending), 0.5) : void 0
      );
    }),
    ...
    (ma.selectAll = function (n) {
      ...
      for (var u = -1, i = this.length; ++u < i; )
        for (var o = this[u], a = -1, c = o.length; ++a < c; )
          (e = o[a]) &&
            (r.push((t = Wo(n.call(e, e.__data__, a, u)))), (t.parentNode = e));
      return p(r);
    });
  var ya = {
  ...
  ($o.ns = {
    ...
    qualify: function (n) {
      ...
      return (
        ...
        ya.hasOwnProperty(e) ? { space: ya[e], local: n } : n
      );
    },
  }),
    ...
    (ma.transition = function () {
      for (
        var n,
          ...
          e = Ss || ++Ns,
          r = [],
          u = ks || { time: Date.now(), ease: Hr, delay: 0, duration: 250 },
          i = -1,
          o = this.length;
        ++i < o;
  ...
  ($o.interpolateZoom = function (n, t) {
    ...
    ($o.behavior.zoom = function () {
      ...
      function l() {
        ...
        function i() {
          for (
            var n, t, e, i, o = $o.touches(p), c = 0, s = o.length;
            s > c;
            ++c, i = null
          )
        ...
        function h() {
          if ($o.event.touches.length) {
            for (
              var t = $o.event.changedTouches, e = 0, r = t.length;
              r > e;
              ++e
            )
      ...
      function h() {
        ...
        y ? clearTimeout(y) : (T.call(this), o(n)),
          (y = setTimeout(function () {
            (y = null), c(n);
          }, 50)),
          f();
        var e = m || $o.mouse(this);
        d || (d = t(e)), r(Math.pow(2, 0.002 * Da()) * S.k), u(e, d), a(n);
      }
      function p() {
        d = null;
      }
      function v() {
        ...
        o(n),
          r(
            Math.pow(
              2,
              $o.event.shiftKey ? Math.ceil(s) - 1 : Math.floor(s) + 1
            )
          ),
          u(e, i),
          a(n),
    ...
    ($o.hcl = function (n, t, e) {
      return 1 === arguments.length
        ? n instanceof W
          ...
          : n instanceof K
          ? nt(n.l, n.a, n.b)
          : nt((n = ft((n = $o.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
        : B(+n, +t, +e);
    });
    ...
    ($o.dsv = function (n, t) {
      ...
      return (
        ...
        (e.parseRows = function (n, t) {
          ...
          for (
            var r, u, i = {}, o = {}, a = [], c = n.length, l = 0, f = 0;
            (r = e()) !== o;
  ...
  ($o.timer = function (n, t, e) {
    ...
    Ba ? (Ba.n = i) : ($a = i),
      (Ba = i),
      Wa || ((Ja = clearTimeout(Ja)), (Wa = 1), Ka(xt));
  }),
  ...
  ($o.formatPrefix = function (n, t) {
    ...
    ($o.format = function (n) {
      ...
      "#" === i ? (i = "") : "$" === i && (i = ec),
        ...
        null != s &&
          ("g" == l
            ? (s = Math.max(1, Math.min(21, s)))
            : ("e" == l || "f" == l) && (s = Math.max(0, Math.min(20, s)))),
        (l = ic.get(l) || St);
      var p = o && c;
      return function (n) {
        if (g && n % 1) return "";
        ...
        return (
          ...
          ("<" === r
            ...
            ? M + t + n
            : "^" === r
            ? M.substring(0, (x >>= 1)) + t + n + M.substring(x)
            : t + (p ? n : M + n)) + h
        );
      };
    });
  var uc =
    ...
    ic = $o.map({
      ...
      r: function (n, t) {
        return (n = $o.round(n, wt(n, t))).toFixed(
          Math.max(0, Math.min(20, wt(n * (1 + 1e-15), t)))
        );
      },
    }),
    oc = vt;
  if (tc) {
    ...
    oc = function (n) {
      for (var t = n.length, e = [], r = 0, u = tc[0]; t > 0 && u > 0; )
        e.push(n.substring((t -= u), t + u)), (u = tc[(r = (r + 1) % ac)]);
  ...
  ($o.geo.bounds = (function () {
    ...
    ($o.geo.centroid = function (n) {
      ...
      return Na > u &&
        ...
        (e = Mc),
        (r = _c),
        Ca > vc && ((t = dc), (e = mc), (r = yc)),
        (u = t * t + e * e + r * r),
        Na > u)
        ? [0 / 0, 0 / 0]
        : [Math.atan2(e, t) * Ta, H(r / Math.sqrt(u)) * Ta];
    });
  var pc,
    vc,
    dc,
  ...
  ($o.geo.path = function () {
    ...
    return (
      ...
      (n.projection = function (n) {
        return arguments.length
          ? ((u = (e = n) ? n.stream || ye(n) : vt), t())
          : e;
      }),
      (n.context = function (n) {
        return arguments.length
          ? ((i = null == (r = n) ? new le() : new de(n)),
    ...
    ($o.geo.rotation = function (n) {
      ...
      return (
        (n = Ee((n[0] % 360) * La, n[1] * La, n.length > 2 ? n[2] * La : 0)),
        (t.invert = function (t) {
          return (
            (t = n.invert(t[0] * La, t[1] * La)), (t[0] *= Ta), (t[1] *= Ta), t
          );
        }),
        t
      );
    ...
    ($o.geo.graticule = function () {
      ...
      function t() {
        return $o
          ...
          .map(h)
          .concat($o.range(Math.ceil(s / m) * m, c, m).map(g))
          .concat(
            $o
  ...
  (($o.geo.stereographic = function () {
    ...
    ($o.geom.hull = function (n) {
      function t(n) {
        ...
        for (i = 1; m > i; ++i)
          (t[i][1] < t[_][1] || (t[i][1] == t[_][1] && t[i][0] < t[_][0])) &&
            (_ = i);
        for (i = 0; m > i; ++i)
          i !== _ &&
            ((c = t[i][1] - t[_][1]),
            (a = t[i][0] - t[_][0]),
            x.push({ angle: Math.atan2(c, a), index: i }));
        for (
          x.sort(function (n, t) {
    ...
    (Zc.clip = function (n) {
      for (
        ...
        for (
          ...
          (o = t[e]),
            $e(o, l, u)
              ? ($e(i, l, u) || n.push(Be(i, o, l, u)), n.push(o))
              : $e(i, l, u) && n.push(Be(i, o, l, u)),
            (i = o);
        a && n.push(n[0]), (l = u);
      }
      return n;
        ...
        if (
          ...
          do {
            ...
            if (n === u.L) {
              if (
                ((t = u.R),
                t.C && ((t.C = !1), (u.C = !0), yr(this, u), (t = u.R)),
                (t.L && t.L.C) || (t.R && t.R.C))
              ) {
                (t.R && t.R.C) ||
                  ((t.L.C = !1), (t.C = !0), xr(this, t), (t = u.R)),
                  (t.C = u.C),
                  (u.C = t.R.C = !1),
                  yr(this, u),
                  (n = this._);
              ...
              ((t = u.L),
              t.C && ((t.C = !1), (u.C = !0), xr(this, u), (t = u.L)),
              (t.L && t.L.C) || (t.R && t.R.C))
            ) {
              (t.L && t.L.C) ||
                ((t.R.C = !1), (t.C = !0), yr(this, t), (t = u.L)),
                (t.C = u.C),
                (u.C = t.L.C = !1),
                xr(this, u),
                (n = this._);
    ...
    ($o.geom.voronoi = function (n) {
      function t(n) {
        var t = new Array(n.length),
          ...
          o = a[1][1];
        return (
          _r(e(n), a).cells.forEach(function (e, a) {
            var c = e.edges,
              s = e.site,
              l = (t[a] = c.length
                ? c.map(function (n) {
      ...
      return n
        ...
        : ((t.links = function (n) {
          ...
          (t.triangles = function (n) {
            var t = [];
            return (
              _r(e(n)).cells.forEach(function (e, r) {
                for (
                  var u,
                    i,
                    o = e.site,
  ...
  ($o.geom.delaunay = function (n) {
    ...
    ($o.geom.quadtree = function (n, t, e, r, u) {
          ...
          if (!isNaN(e) && !isNaN(r))
            if (n.leaf) {
              var c = n.x,
                l = n.y;
              if (null != c)
                if (aa(c - e) + aa(l - r) < 0.01) s(n, t, e, r, u, i, o, a);
                else {
                  var f = n.point;
      ...
      return (o = arguments.length)
        ? ((a = Sr), (c = kr), 3 === o && ((u = e), (r = t), (e = t = 0)), i(n))
        : ((i.x = function (n) {
    ...
    ($o.layout.force = function () {
      ...
      return (
        (a.tick = function () {
          ...
          if (g)
            for (fu((t = $o.geom.quadtree(d)), r, o), e = -1; ++e < _; )
          ...
          return (
            e ||
              (e = $o.behavior
                .drag()
                .origin(vt)
                .on("dragstart.force", au)
                .on("drag.force", t)
                .on("dragend.force", cu)),
            arguments.length
              ? (this.on("mouseover.force", su)
                  .on("mouseout.force", lu)
                  .call(e),
                void 0)
              : e
          );
  ...
  $o.layout.stack = function () {
    ...
    return (
      ...
      (n.order = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : as.get(t) || Mu), n)
          : e;
      }),
      (n.offset = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : cs.get(t) || _u), n)
          : r;
      }),
      (n.x = function (t) {
        return arguments.length ? ((i = t), n) : i;
      ...
      if (g > 0)
        for (i = -1; ++i < h; )
          (a = s[i]),
            a >= l[0] &&
              a <= l[1] &&
              ((o = c[$o.bisect(f, a, 1, g) - 1]), (o.y += p), o.push(n[i]));
      return c;
    }
    var t = !0,
      e = Number,
          ...
          if (t) {
            for (
              ...
              (c = Nu(c)),
                ...
                u > 0 && (Uu(ju(a, n, r), n, u), (s += u), (l += u)),
                (f += a._tree.mod),
                (s += i._tree.mod),
                (h += c._tree.mod),
                (l += o._tree.mod);
            a && !Lu(o) && ((o._tree.thread = a), (o._tree.mod += f - l)),
              i &&
                !Nu(c) &&
      ...
      return (
        ...
        (i.padding = function (n) {
          function t(t) {
            ...
            return null == e
              ? Ku(t)
              : Qu(t, "number" == typeof e ? [e, e, e, e] : e);
          }
          function e(t) {
            return Qu(t, n);
          }
  ...
  (Cs.call = ma.call),
      ...
      function u(t) {
        return null == t
          ...
          : ((t += ""),
            function () {
              var r,
                u = Ko.getComputedStyle(this, null).getPropertyValue(n);
              return (
                u !== t &&
                ((r = qr(u, t)),
                function (t) {
    ...
    (Cs.styleTween = function (n, t, e) {
      function r(r, u) {
        var i = t.call(
          ...
          r,
          u,
          Ko.getComputedStyle(this, null).getPropertyValue(n)
        );
        return (
          i &&
          function (t) {
    ...
    (Cs.ease = function (n) {
      ...
      return arguments.length < 1
        ...
        : ("function" != typeof n && (n = $o.ease.apply($o, arguments)),
          C(this, function (e) {
  ...
  var Ls = "bottom",
    Ts = { top: 1, right: 1, bottom: 1, left: 1 };
  $o.svg.brush = function () {
    ...
    function u() {
      function u() {
        32 == $o.event.keyCode &&
          (C || ((x = null), (L[0] -= l[1]), (L[1] -= h[1]), (C = 2)), f());
      }
      function g() {
        32 == $o.event.keyCode &&
          2 == C &&
          ((L[0] += l[1]), (L[1] += h[1]), (C = 0), f());
      }
      function d() {
        var n = $o.mouse(_),
          u = !1;
      ...
      function m(n, t, e) {
        ...
        return (
          ...
          C
            ? (u = (r += f) + d)
            : (x && (f = Math.max(c, Math.min(s, 2 * x[e] - r))),
              r > f ? ((u = r), (r = f)) : (u = f)),
          g[0] != r || g[1] != u
      ...
      if (
        ($o.event.changedTouches
          ? T.on("touchmove.brush", d).on("touchend.brush", y)
          : T.on("mousemove.brush", d).on("mouseup.brush", y),
  ...
  (Rs.year = co(
    ...
    Ps.forEach(function (n, t) {
      ...
      var e = (Rs[n] = co(
        function (n) {
          return (
            (n = Rs.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          );
        },
        function (n, t) {
